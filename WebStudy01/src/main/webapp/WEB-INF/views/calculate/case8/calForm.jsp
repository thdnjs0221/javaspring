...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/app/calculate/calForm_case8.js"></script>

</head>
<body>
<div style="border:1px solid black">
	<h4>request content Type</h4>
	<input type="radio" name="contentType" checked/>HTML
	<input type="radio" name="contentType"   data-content-type="application/json;charset=UTF-8"/>JSON

</div>
<div style="border:1px solid black">
	<h4>response content Type</h4>
	<input type="radio" name="accept"  value="html" />PARAMETER
	<input type="radio" name="accept"   value="" checked />JSON
